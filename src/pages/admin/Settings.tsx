  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={onSave} className="space-y-6">
        ...
        <div className="rounded-[24px] border border-[#E8F1FF] dark:border-[#1E2A4A]/50 bg-white dark:bg-[#131C32] p-6 shadow-xs space-y-4">
          <h3 className="text-sm font-black text-slate-900 dark:text-white uppercase tracking-wider border-b border-slate-50 dark:border-slate-800/60 pb-3">Kênh mạng xã hội & Hotline</h3>
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              <label className="block text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 mb-1.5">Facebook Messenger URL</label>
              <input
                type="text"
            ...
            <div>
              ...
              <input
                ...
                placeholder="email@shopofbow.com..."
                className="h-11 w-full rounded-xl border border-[#DCEAFF] dark:border-[#1E2A4A] bg-white dark:bg-[#131C32] px-3.5 text-xs font-bold outline-none transition focus:border-[#2563EB]"
              />
            </div>
          </div>
